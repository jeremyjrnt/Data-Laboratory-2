...
def call_ollama_llm(prompt: str, llm_model: str = "gemma3:4b", max_retries: int = 5) -> str:
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--vectordb-dir", type=str, default="VectorDBs", help="Directory with centroids/assignments/metadata")
