    ...
    def _load_models(self):
        ...
        try:
            ...
            try:
                ...
                # Fallback: use text projection output dimension
                try:
                    self.embedding_dim = self.clip_model.text_projection.out_features
                except:
                    # Final fallback: standard CLIP ViT-L/14 dimension
                    self.embedding_dim = 768
                    logger.warning("Using 768")
